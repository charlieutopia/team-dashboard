...
export function buildMonthlyPrompt(input: AnalyzeMonthlyInput): string {
  ...
  return [
    `You are writing a MONTHLY activity note for the Boss to read on her phone on the first of the month.`,
    ...
    ``,
    `The summary is the Boss's whole window into ${firstName}'s month. She reads on her phone first thing on the 1st. She has 30 seconds.`,
    ``,
    ...
    `5. **180-280 words. Hard cap 280.** A month deserves a richer narrative than a week, but Boss is still on her phone.`,
