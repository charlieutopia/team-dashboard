...
export function buildWeeklyPrompt(input: AnalyzeWeeklyInput): string {
  ...
  return [
    `You are writing a WEEKLY activity note for Charlie to read on her phone Monday morning.`,
    ...
    ``,
    `The summary is Charlie's whole window into ${firstName}'s week. She reads on Monday morning. She has 15 seconds.`,
    ``,
